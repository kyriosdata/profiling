...
InstanceOf: Patient
Usage: #example
Title: "Apenas ilustra instância de recurso"
Description: "Uma instância para ambientação"

// Um identificador de negócio para o paciente
// neste caso, a CNH provisória (#temp)
...
* identifier[0].value = "123.23232.23232.23232"

// Quem emitiu 
// (neste caso, a organização está disponível no mesmo servidor)
// (O identificador lógico do DETRAN-GO, 12345, neste servidor)
* identifier.assigner.reference = "Organization/12345"
* identifier.assigner.type = "Organization"
* identifier.assigner.display = "DETRAN de Goiás"

// Outro identificador de negócio para o paciente
// neste caso, o CPF
...
// Quem emitiu
// (neste caso, a organização está disponível em outro servidor)
* identifier.assigner.reference = "http://receita.brasil/cpf"
* identifier.assigner.type = "Organization"
...
* address[1].use = #work
* address[1].type = #both
* address[1].text = "Endereço Fictício de Hospital em Anápolis, Goiás"
...
* generalPractitioner[0].reference = "Organization/123"